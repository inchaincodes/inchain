 ...
 *
 */
public abstract class CommonlyTransaction extends Transaction {
...
//		}
	...
	public void verfifyScript() {
		//除转账交易外的通用验证脚本
		CommonlyTransaction tempTransaction = (CommonlyTransaction) network.getDefaultSerializer().makeTransaction(baseSerialize(), 0);
