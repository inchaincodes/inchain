...
public class ConfigurableProcessor
{
	 ...
	 * Transformation is done using {@link com.week08.loadConfig.configuration.aionemu.commons.configuration.PropertyTransformerFactory}
	 * 
	 * @param field
	...
	private static String findPropertyByKey(String key, Properties[] props)
	{
		for(Properties p : props)
		{
			...
			{
				try {
					return new String(p.getProperty(key).getBytes("Latin1"),"utf8");
				} catch (UnsupportedEncodingException e) {
					log.warn("new string error!", e);
				}
			}
		}
